...
export default function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <article className="group h-full bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col hover:border-zinc-600 hover:shadow-lg hover:shadow-black/30 transition-all duration-200">
      {/* Slate icon container — no yellow */}
      ...
      <a
        href="#contact"
        className="mt-5 inline-flex items-center gap-1 text-zinc-500 hover:text-zinc-300 text-xs font-semibold tracking-wide transition-colors duration-200"
